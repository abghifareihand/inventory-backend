    ...
    <section class="section">
       <div class="section-header d-flex">
            ...
            <div class="section-header-button ml-auto">
                <a href="{{ route('owner.stock.pusat.create') }}" class="btn btn-primary">Tambah Stock</a>
            </div>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    <a href="{{ route('owner.stock.pusat.edit', $stock->id) }}" class="btn btn-sm btn-info btn-icon ml-2">
                                                        <i class="fas fa-edit"></i> Edit
                                                    </a>
                                                    <a href="{{ route('owner.stock.pusat.distribution.form', $stock->id) }}"
